 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	title: `[ 𝚂𝚑𝚘𝚙  / 𝙳𝚊𝚒𝚕𝚢  / 𝙿𝚛𝚘𝚏𝚒𝚕𝚎 ]`,
	rows: [
	    {title: `[ 🏷 ] Sewa BOT`, rowId: ".sewabot", description: "Menampilkan list harga sewa BOT"},
	    {title: `[  ⨷ ]  Pengen Sc Aja Bang☕︎🗿`, rowId: "p", description: "Hamdeh"},
	...
	{title: `[ 📥 ]ownloader`, rowId: ".? downloader", description: "Jangan download yg aneh-aneh, Xixixi"},
	...
	rows: [
	    ...
	    {title: `[ 📔 ] Script`, rowId: ".sc2", description: `Hamdeh Pengen Sc ${namebot}`},
	  ...
	  {title: `[ 💡 ] Group Official Bot`, rowId: ".groupbot", description: 'Jangan lupa mampir yo'},
...
let tek = `
 ...
 │⬡ Premium : *${usrs.premiumTime > 1 ? '𝙸𝚢𝚊': '𝚃𝚒𝚍𝚊𝚔'}* 
